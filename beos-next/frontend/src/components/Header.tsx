...
// @ts-ignore - AuthContext is not yet converted to TS
import { useAuth } from '../context/AuthContext';
import { Droplet, Map, Activity, LogOut, User, Menu } from 'lucide-react';
import ThemeToggle from './ThemeToggle';
// @ts-ignore - MobileMenu is not yet converted to TS
...
const Header: React.FC = () => {
    ...
    const { isAuthenticated, logout, user } = useAuth() as AuthContextType;
