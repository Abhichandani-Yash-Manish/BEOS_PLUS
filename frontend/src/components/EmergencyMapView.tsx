...
export const EmergencyMapView: React.FC<EmergencyMapViewProps> = ({ requests, donorCity, onRespond }) => {
            ...
            <div className="map-container">
                ...
                <div className="radar-base">
                    ...
                    <div className="map-center">
                        ...
                        <span className="center-label">You ({donorCity || 'Unknown'})</span>
                    </div>
...
export const MissionControlHeader: React.FC<MissionControlHeaderProps> = ({ profile, available, onToggle, stats, loading }) => {
    const getRank = (donationCount: number): Rank => {
