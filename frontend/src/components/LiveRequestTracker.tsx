...
import { BloodRequest, Hospital } from '../types/models';
...
export const LiveRequestTracker: React.FC<LiveRequestTrackerProps> = ({ requests, onRequestClick }) => {
                        ...
                        >
                            ...
                            <div className="tracker-meta">
                                <span className="tracker-time">
                                    Created: {req.created_at ? new Date(req.created_at).toLocaleTimeString() : 'Unknown Time'}
                                </span>
                            </div>
                        </div>
                    );
...
interface MassCasualtyTriggerProps {
    onTrigger: (active: boolean) => void;
    isActive: boolean;
    loading?: boolean;
}

export const MassCasualtyTrigger: React.FC<MassCasualtyTriggerProps> = ({ onTrigger, isActive, loading }) => {
...
export const HospitalStatsGrid: React.FC<HospitalStatsGridProps> = ({ requests, profile }) => {
